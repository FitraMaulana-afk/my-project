<div id="mobile-menu"
    ...
    <div class="lg:hidden flex w-full items-center justify-between">
        <div class="px-4 py-2 mx-6 my-6">
            <a href="" class="flex items-center justify-center w-full">
                <p class="md:text-lg text-lg font-semibold text-center">Ayo Dolan</p>
            </a>
        </div>
        <button id="close-toggle" class="px-4 py-2 mx-6 my-4">
            <i class="fa-solid fa-xmark text-2xl text-primaryBlue"></i>
        </button>
    </div>
    <div class="w-full hidden lg:flex justify-center my-10">
        <a href="" class="flex items-center">
            ...
            <p class="md:text-lg text-2xl font-semibold ">Ayo Dolan</p>
        </a>
    </div>
    ...
    <div class="mx-6 mt-10" class="w-full">
        <div
            class="  font-semibold text-dark hover:text-white hover:bg-primaryBlue transition-all ease-in-out py-4 px-6 rounded-lg duration-150">
            <a class="flex"
