<x-landing.base title="Destination">
    <div class="h-[350px] bg-cover bg-center w-full   bg-no-repeat "
        ...
        <div class="flex w-full h-full items-center justify-center" data-aos="zoom-in-up" data-aos-duration="1000">
            <h1 class="text-4xl font-bold text-white">DESTINATION</h1>
        </div>
    </div>
    <div class="container ">
